    ...
    <>
      <main className="flex min-h-screen flex-col bg-[#121212]">
        <div className="container mx-auto md:px-6">
          <div className="relative rounded-lg overflow-hidden bg-cover bg-no-repeat bg-[50%] bg-[url('/images/background.jpeg')] h-[400px]"></div>
          <div className="container mx-auto px-6 md:px-12 xl:px-32">
            <div className="text-center">
              <div className="mt-[-160px] block rounded-lg bg-gray-500 px-6 py-1 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[30px] dark:bg-[hsla(0,0%,5%,0.55)] dark:shadow-black/20 md:py-16 md:px-12">
